...
export const EN_TRANSLATIONS: TranslationCatalog = {
  ...
  'reportForm.step4Title': 'Condition of the home',
  'reportForm.step4Subtitle': 'Mark the visible damage shown in the photos.',
  'reportForm.notice': 'Description of the damage',
